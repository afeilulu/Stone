...
import com.afeilulu.stone.fragment.SearchFragment;
import com.afeilulu.stone.settings.AboutActivity;
import com.afeilulu.stone.util.UIUtils;
import com.afeilulu.stone.widget.MultiSwipeRefreshLayout;
import com.afeilulu.stone.widget.SwipeRefreshLayout;
...
public class HomeActivity extends Activity
    ...
    private final static String TAG = LogUtil.makeLogTag(HomeActivity.class);
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        View mainContent = findViewById(R.id.swipe_refresh_layout);
        if (mainContent != null) {
    ...
    public void onSearchAttached(String searchString){
    }
    ...
    protected void onResume() {
        ...
        ListView listView = mSearchFragment.getListView();
        if (listView != null)
            listView.setPadding(listView.getPaddingLeft(),actionBarClearance,
    ...
    public boolean canSwipeRefreshChildScrollUp() {
        if (mSearchFragment != null){
            return mSearchFragment.canCollectionViewScrollUp();
        }
        return false;
    }
